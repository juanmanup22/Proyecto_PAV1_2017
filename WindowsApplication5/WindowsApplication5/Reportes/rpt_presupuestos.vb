...
Public Class rpt_presupuestos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication5.rpt_presupuestos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_presupuestos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_presupuestos = New rpt_presupuestos()
        rpt.Site = Me.Site
        Return rpt
    End Function
